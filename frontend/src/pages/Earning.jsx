    ...
    <>
      <div className="earning_page">
        <div className="earning_cards flex justify-content-between align-content-center gap-4 flex-wrap">
          <Earning_card title={"Revenue"} revenue={"3425"} percentage={"10"} />
          <Earning_card title={"Expense"} revenue={"345"} percentage={"15"} />
          <Earning_card title={"Profit"} revenue={"2768"} percentage={"26"} />
        </div>
